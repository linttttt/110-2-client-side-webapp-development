...
figEx$split_css$`englishCard-content-word-title`$remain$border <- NULL
figEx$split_css$`englishCard-content-word`$remain$height <- NULL
figEx$split_css$`englishCard-content-word-expl`$remain$height <- NULL
